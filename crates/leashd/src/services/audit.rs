...
use leash_ai_api::pb::audit_service_server::AuditService;
use leash_ai_api::pb::{QueryAuditLogsRequest, QueryAuditLogsResponse, AuditEntry};
use crate::LeashDaemon;
use chrono::{Utc, TimeZone};

#[tonic::async_trait]
impl AuditService for LeashDaemon {
